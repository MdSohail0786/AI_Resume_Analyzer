      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 animate-slide-up">
          ...
          <p className="text-slate-500 mt-1">
            Upload your PDF and paste a job description to get your AI match
            score.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                {file ? (
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1">
                      Text-based PDFs only (not scanned)
                    </p>
                  </div>
                )}
              </div>
            ...
            <div
              className="bg-white rounded-2xl shadow-card border border-slate-100 p-6 animate-slide-up"
            ...
            >
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Paste from LinkedIn, Naukri, Indeed, etc.
                  </p>
                </div>
                {jobDesc.length > 0 && (
                  <span
...
Nice to have: Docker, AWS, GraphQL..."
          ...
          <div className="space-y-6">
            ...
            {/* Status Card */}
            <div
              className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-6 text-white animate-slide-up"
